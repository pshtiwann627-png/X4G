...
.copy-all-btn:hover{transform:translateY(-2px) scale(1.02);box-shadow:0 8px 28px rgba(0,0,0,0.12)}
...
.footer{text-align:center;padding-top:32px;font-size:10.5px;color:var(--text-dim)}
