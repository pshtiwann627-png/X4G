...
def get_public_page_html(uuid_key: str) -> str:
    """صفحه پابلیک ساب — نسخه‌ی نهایی با تاریخ و زمان زنده، نمودارها، دکمه‌های ساب،
       دکمه‌ی کپی همه در پایین، و دکمه‌ی کشویی پشتیبانی"""
...
.copy-all-bar-bottom .copy-all-text{flex:1;min-width:160px;position:relative;z-index:1}
.copy-all-bar-bottom .copy-all-title{font-size:14px;font-weight:800;color:#fff;display:flex;align-items:center;gap:7px}
.copy-all-bar-bottom .copy-all-sub{font-size:10px;color:rgba(255,255,255,0.65);margin-top:3px}
.copy-all-bar-bottom .copy-all-btn{
  background:#fff;color:#1D4ED8;border:none;border-radius:14px;
  padding:11px 24px;font-family:inherit;font-size:12.5px;font-weight:800;
  cursor:pointer;display:flex;align-items:center;gap:7px;
  transition:all 0.35s cubic-bezier(0.34,1.56,0.64,1);white-space:nowrap;position:relative;z-index:1
}
.copy-all-bar-bottom .copy-all-btn:hover{transform:translateY(-2px) scale(1.02);box-shadow:0 8px 28px rgba(0,0,0,0.12)}
.copy-all-bar-bottom .copy-all-btn:active{transform:translateY(0) scale(0.96)}
...
@media(max-width:560px){
  ...
  .copy-all-bar-bottom{flex-direction:column;align-items:stretch}
  .copy-all-bar-bottom .copy-all-btn{justify-content:center}
...
function renderContent(d){
  ...
  document.getElementById('root').innerHTML = `
    ...
    <!-- دکمه‌ی کپی همه در پایین صفحه -->
    <div class="copy-all-bar-bottom">
      ...
      <button class="copy-all-btn" onclick="copyAllConfigs()"><i class="ti ti-clipboard-copy"></i> کپی همه</button>
    </div>
  `;
